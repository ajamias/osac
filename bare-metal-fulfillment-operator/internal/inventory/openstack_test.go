...
func TestValidateMatchExpressions(t *testing.T) {
	tests := []struct {
		...
		{
			name:             "reserved bareMetalInstanceId key",
			matchExpressions: map[string]string{"bareMetalInstanceId": "some-value"},
			wantError:        true,
			errorContains:    "reserved label key",
		},
		{
			name:             "reserved managedBy key",
			matchExpressions: map[string]string{"managedBy": "some-value"},
			wantError:        true,
			errorContains:    "reserved label key",
		},
		{
			name:             "reserved bareMetalPoolId key",
			matchExpressions: map[string]string{"bareMetalPoolId": "some-value"},
			wantError:        true,
			errorContains:    "reserved label key",
		},
		{
...
func TestFindFreeHostValidation(t *testing.T) {
	tests := []struct {
		...
		{
			name:             "reserved bareMetalInstanceId rejected",
			matchExpressions: map[string]string{"bareMetalInstanceId": "some-value"},
			errorContains:    "reserved label key",
		},
		{
			name:             "reserved managedBy rejected",
			matchExpressions: map[string]string{"managedBy": "some-value"},
			errorContains:    "reserved label key",
		},
		{
			name:             "reserved bareMetalPoolId rejected",
			matchExpressions: map[string]string{"bareMetalPoolId": "some-value"},
			errorContains:    "reserved label key",
		},
		{
